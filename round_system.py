...
class RoundSystem:
    ...
    def spawn_enemy(self, enemies, background):
    ...
    def display_game_round(self, window):
        ...
        round_text = PIXEL_FONT_BIG_BUTTON.render(round_text, True, COLORS['white'])
