...
PLAYER_WALK_RIGHT = [pygame.image.load('./data/player-images/R1.png'), pygame.image.load('./data/player-images/R2.png'), pygame.image.load('./data/player-images/R3.png'),
                     pygame.image.load('./data/player-images/R4.png'), pygame.image.load('./data/player-images/R5.png'), pygame.image.load('./data/player-images/R6.png'),
...
PLAYER_WALK_LEFT = [pygame.image.load('./data/player-images/L1.png'), pygame.image.load('./data/player-images/L2.png'), pygame.image.load('./data/player-images/L3.png'),
                    pygame.image.load('./data/player-images/L4.png'), pygame.image.load('./data/player-images/L5.png'), pygame.image.load('./data/player-images/L6.png'),
...
class Player:
    ...
    def draw(self, window):
        ...
        if not self.standing:
            if self.left:  
                window.blit(PLAYER_WALK_LEFT[self.walk_count // 3], (self.x, self.y))
                self.walk_count += 1                          
            elif self.right:
                window.blit(PLAYER_WALK_RIGHT[self.walk_count // 3], (self.x, self.y))
                self.walk_count += 1
        else:
            if self.left:
